namespace CADInfo
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.BaseCodePage = new System.Windows.Forms.TabPage();
			...
			this.tabControl.Controls.Add(this.BaseCodePage);
			...
			this.GrayCodePage.Name = "GrayCodePage";
			...
			// BaseCodePage
			// 
			this.BaseCodePage.Location = new System.Drawing.Point(4, 22);
			this.BaseCodePage.Name = "BaseCodePage";
			this.BaseCodePage.Padding = new System.Windows.Forms.Padding(3);
			this.BaseCodePage.Size = new System.Drawing.Size(717, 595);
			this.BaseCodePage.TabIndex = 6;
			this.BaseCodePage.Text = "7. Base 64";
			this.BaseCodePage.UseVisualStyleBackColor = true;
			// 
			// splitContainer
			// 
		...
		private System.Windows.Forms.TabPage BaseCodePage;
